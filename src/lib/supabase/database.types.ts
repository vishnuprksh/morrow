...
export type Database = {
  public: {
    Tables: {
      ...
      notes: {
        Row: { id: string; user_id: string; folder_id: string | null; title: string; content_markdown: string; version: number; is_favorite: boolean; is_archived: boolean; deleted_at: string | null; created_at: string; updated_at: string };
        Insert: { id?: string; user_id: string; folder_id?: string | null; title?: string; content_markdown?: string; version?: number; is_favorite?: boolean; is_archived?: boolean; deleted_at?: string | null; created_at?: string; updated_at?: string };
        Update: { id?: string; user_id?: string; folder_id?: string | null; title?: string; content_markdown?: string; version?: number; is_favorite?: boolean; is_archived?: boolean; deleted_at?: string | null; created_at?: string; updated_at?: string };
        Relationships: [];
      };
      ai_credentials: {
