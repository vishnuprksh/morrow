...
const folders = [
  ...
  { name: 'Projects', count: 12, open: true },
  { name: 'Reading list', count: 5, open: false },
];

const notes = [
  { title: 'Welcome to Morrow', folder: 'Personal', active: true },
  { title: 'Ideas worth exploring', folder: 'Personal' },
  { title: '2025 reflections', folder: 'Personal' },
];
