...
## Corpus Check
- 46 files · ~12,055 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 258 nodes · 311 edges · 40 communities (17 shown, 23 thin omitted)
...
Cohesion: 0.13
Nodes (20): AgentPanel(), ChatMessage, NoteContext, FolderRow, NoteRow, RecoveryNotice(), AutosaveController, AutosaveResult (+12 more)
...
## Knowledge Gaps
- **112 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `nextConfig`, `name` (+107 more)
