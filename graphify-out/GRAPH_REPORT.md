...
## Summary
- 332 nodes · 443 edges · 30 communities (22 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `de932a45`
...
Cohesion: 0.25
Nodes (7): AgentPanel(), send(), ChatMessage, extractNoteChangeProposal(), NoteContext, activeNote, visibleAssistantText()
...
## Knowledge Gaps
- **120 isolated node(s):** `ChatMessage`, `NoteContext`, `PortableFolder`, `PortableNote`, `Agent` (+115 more)
...
- **What connects `ChatMessage`, `NoteContext`, `PortableFolder` to the rest of the system?**
