...
## Summary
- 327 nodes · 434 edges · 29 communities (21 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `18340485`
...
- `uploadImage()` --calls--> `createClient()`  [EXTRACTED]
...
Cohesion: 0.09
Nodes (22): AuthForm(), submit(), SignOutButton(), FolderRow, moveToTrash(), NoteRow, NoteView, RecoveryNotice() (+14 more)
...
### Community 4 - "Home"
Cohesion: 0.10
Nodes (20): ForgotPasswordPage(), submit(), UpdatePasswordPage(), submit(), Home(), acceptProposal(), archiveNote(), bulkMoveToTrash() (+12 more)
...
## Knowledge Gaps
- **119 isolated node(s):** `ChatMessage`, `NoteContext`, `EditAction`, `ImageSize`, `MarkdownEditorProps` (+114 more)
...
- **Why does `createClient()` connect `Home` to `app/page.tsx`, `portability.ts`, `createClient`, `vault-import.ts`?**
