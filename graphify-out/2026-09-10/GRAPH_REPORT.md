...
## Corpus Check
- 60 files · ~31,508 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 328 nodes · 435 edges · 29 communities (21 shown, 8 thin omitted)
...
## Knowledge Gaps
- **119 isolated node(s):** `semi`, `singleQuote`, `trailingComma`, `nextConfig`, `name` (+114 more)
